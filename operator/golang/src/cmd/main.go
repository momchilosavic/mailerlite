...
import (
	...
	mailerlitev1 "github.com/momchilosavic/mailerlite/api/v1"
	"github.com/momchilosavic/mailerlite/internal/controller"
...
func init() {
	...
	utilruntime.Must(mailerlitev1.AddToScheme(scheme))
